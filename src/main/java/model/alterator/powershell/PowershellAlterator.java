 ...
 */
package model.alterator.powershell;
 ...
 * <code>PowershellClass</code> implementation of the <code>IClass</code>
 * interface.
 *
 * It alterates the variables, functions and the script of the
 * <code>PowershellClass</code>.
 *
 * @author Max 'Libra' Kersten [@LibraAnalysis]
 */
public class PowershellAlterator extends GenericAlterator implements IAlterator {
    ...
    /**
     * Alterates the <code>PowershellClass</code> specific <code>script</code>
     * field.
     *
