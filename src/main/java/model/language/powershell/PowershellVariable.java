...
/**
 * A variable for the <code>PowershellClass</code>, which extends the
 * <code>IVariable</code> interface and inherits functionality from the
 * <code>GenericVariable</code>.
 *
 * @author Max 'Libra' Kersten [@LibraAnalysis]
 */
public class PowershellVariable extends GenericVariable implements IVariable {

    /**
     * Creates an instance of the <code>PowershellVariable</code> class, which
     ...
     */
    public PowershellVariable(String name, String body) {
        super(name, body);
    }
    ...
    @Override
    public String build() {
        //Returns the variable in the form of "$[name] = [body]
        return "$" + super.getName() + ClassConstants.SET_EQUALS + super.getBody();
    }
